...
table.apx-table tbody td.primary-col{font-family:'Barlow Condensed',sans-serif;font-weight:700;font-size:.92rem;color:var(--text);letter-spacing:.04em;}
...
.empty-state i{font-size:2.5rem;color:var(--surface-3);margin-bottom:16px;display:block;}
...
.event-time{font-family:'Barlow Condensed',sans-serif;font-size:.82rem;color:var(--text-muted);white-space:nowrap;}
